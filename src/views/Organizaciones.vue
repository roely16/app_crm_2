<template>
    <div>
        <b-container fluid>
            ...
            <b-row>
                <b-col>
                    <TablaCrud url_delete="eliminar_organizacion" :items="items_tabla" :fields="fields_tabla" showDelete showEdit @editMode="(value) => { 
						titleModal = 'Editar Organización'
						showModal = true 
						idConvivencia = value
						editMode = true
                        ...
                        <template v-slot:button-add>
							<b-button variant="primary" @click="() => {
								showModal = true
								titleModal = 'Registrar Organización'
							}">
								Agregar
...
<script>
    ...
    import FormRegistro from '@/components/Organizaciones/FormRegistro.vue'
    ...
    export default {
        ...
        data(){
            return{
                items: [
                    ...
                    {
                        text: 'Organización de CUBs ó COCODES',
                        active: true
                    }
                ],
                items_tabla: [],
        ...
        methods: {
            obtener_datos(){
                ...
                this.axios
                .post(process.env.VUE_APP_API_URL + 'obtener_organizaciones', data)
