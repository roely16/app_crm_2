    ...
    <div>
        <b-container fluid>
            ...
            <b-row class="mt-4 mb-4">
                <!-- <b-col cols="3">
                    <b-row>
                        <b-col cols="12" @click="detalle_contactos_ingresados">
            ...
            <b-row v-if="!loadingIndicadores">
                <b-col cols="3" v-for="(indicador, key) in indicadores" :key="key">
                    <b-card class="shadow-lg p-3 mb-5 bg-white rounded">
                        <CircleChart showDetail :id_indicador="indicador.id" :url_data="indicador.url_datos" :id_clasificacion="indicador.id_clasificacion" :title_chart="indicador.nombre" :id_container="indicador.container" :processChart="processChart" :config_reporte="reporte" @loadEnd="loadEnd" />
                    </b-card>
                </b-col>
            </b-row>
