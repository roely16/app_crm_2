    ...
    export default {
        ...
        methods: {
            ...
            registrar(){
                ...
                this.axios
                .post(process.env.VUE_APP_API_URL + "registrar_organizacion", this.reunion)
            ...
            obtener_detalle(){
                ...
                this.axios
                .get(process.env.VUE_APP_API_URL + "detalle_organizacion/" + this.idReunion)
                .then(response => {
            ...
            editar(){
                ...
                this.axios
                .post(process.env.VUE_APP_API_URL + "editar_organizacion", this.reunion)
                // eslint-disable-next-line no-unused-vars
                .then(response => {
