    ...
    export default {
        ...
        methods: {
            ...
            registrar(){
                ...
                this.axios
                .post(process.env.VUE_APP_API_URL + "registrar_visita", this.reunion)
                // eslint-disable-next-line no-unused-vars
                .then(response => {
                    // eslint-disable-next-line no-undef
                    Swal.fire(
                        "Excelente!",
                        "La visita ha sido registrada!",
                        "success"
                    ).then(() => {
                        this.$emit('listar')
                        this.closeModal()
            ...
            obtener_detalle(){
                ...
                this.axios
                .get(process.env.VUE_APP_API_URL + "detalle_visita/" + this.idReunion)
                .then(response => {
            ...
            editar(){
                ...
                this.axios
                .post(process.env.VUE_APP_API_URL + "editar_visita", this.reunion)
                // eslint-disable-next-line no-unused-vars
                .then(response => {
