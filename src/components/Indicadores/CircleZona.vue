    ...
    <div>
        ...
        <b-row>
            ...
            <b-col class="text-center" style="cursor: pointer" @click="mostrar_detalle()">
                <b-badge variant="danger">META: {{ grafica.meta }}</b-badge>
        ...
        <Modal sizeModal="xl" :titleModal="'Detalle de ' + title_chart" @closeModal="() => { showModal = false }" :showModal="showModal">
            <template v-slot:form>
                <DetalleIndicador :id_indicador="id_indicador" :url_data="url_data" :config_reporte="config_reporte"></DetalleIndicador>
            </template>
        </Modal>
    ...
    export default {
        ...
        methods: {
            ...
            obtener_datos(){
                ...
                data.id_clasificacion = this.id_clasificacion
                data.id_indicador = this.id_indicador

                data.zonas = [this.zona];
